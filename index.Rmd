...
library(glue) #[4]. Glue and italicize column
library(ggtext) #[5]. Modify plot texts
```
...
[@bookdown2016]; [@ggplot22016]; [@knitr2015]; [@knitr2014]; [@rmarkdown2018]; [@rmarkdown2020]; [@tidyverse2019]; [@R-ggtext]; [@R-glue].
...
knitr::write_bib(c(
  .packages(), 'bookdown', 'knitr', 'rmarkdown', 'kableExtra', 'tidyverse', 'glue', 'ggtext'
), 'packages.bib')
```
