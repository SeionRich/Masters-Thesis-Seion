...
### Weight distributions of the thirty (30) most common fish species (by weight) discarded{#id.31}
...
```{r fig31, fig.height = 4.5, fig.align = "center", fig.cap = "Scatter plot of discarded fish species weights across bottom trawl fishing tows. A total of 48 bottom trawl fishing tows were made. Most of the weight observations are below 125 kgs" }
...
```{r fig33,  fig.width = 8, fig.height = 5.5, fig.align = "center", fig.cap = "Boxplot of discarded fish species weights by time of day. Colours are used to represent the different fish species"}
...
```{r fig34,  fig.width = 8, fig.height = 5.5, fig.align = "center", fig.cap = "Boxplot of discarded fish species weights by fishing depths. Colours are used to represent the different fish species"}
...
Of the total discard fish species weights (5,403 kgs) for the top 6 fish species, 48% (2,574 kgs) were recorded for the deep and 52% (2,829 kgs) for the shallow (Table \@ref(tab:tab33)). This means that the cumulative fish species weights were marginally higher in the shallow when compared to the deep. Further, we see that the total weights by fish species in the deep ranged from 91 kgs(*Trichiurus lepturus*) to 689 kgs(*Stellifer rastrifer*). Whereas the total weights in the shallow ranged from 159 kgs (*Trichiurus lepturus*) to 882 kgs (*Stellifer rastrifer*). From Figure \@ref(fig:fig34) and Table \@ref(tab:tab33) we see that *Trichiurus lepturus* had the lowest median weights across fishing depths i.e. 2 kgs (deep) and 4 kgs (shallow) for the top 6 fish species examined. While *Stellifer rastrifer* recorded the highest median weights for both the deep (30 kgs) and shallow (34 kgs). Therefore, we can conclude that *Stellifer rastrifer* was the most dominant discarded fish species across fishing depths with the highest total wight and median, while *Trichiurus lepturus* was the least dominant discarded fish species i.e. recording the lowest total weight and median across fishing depths.  
...
```{r fig35, fig.align = "center", fig.cap = "Scatter plot of discarded fish species weights across bottom trawl fishing tows. A total of 48 bottom trawl fishing tows were made. Most of the weight observations are below 125 kgs"}
...
From Figure \@ref(fig:fig36) we see that the they were five abnormally high data points. These were for discarded fish species *Trichiurus lepturus*(219.586 kgs), *Symphurus plagusia*(178.964 kgs), *Stellifer rastrifer*(163.973 kgs), *Dasyatis geijskesi*(161.077 kgs) and *Stellifer microps*(132.773). As mentioned before these points are strangely high and therefore are perceived to be incorrectly entered and thus will be omitted from the analysis. 

### Discard weight distribution for all fish species, across time of day and fishing depths.

#### Time of day

```{r fig37, fig.align = "center", fig.cap = "Density plot of discarded fish species weight-distribution by time of day. Colours used to represent the different time of day"}
...
```{r fig38, fig.align = "center", fig.cap = "Density plot of discarded fish species weight-distribution by time of day. Colours used to represent the different time of day"}
...
```{r fig310, fig.align = "center", fig.cap = "Density plot of discarded fish species weight-distribution by fishing depths. Colours used to represent the different fishing depths"}
